...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('https://deep-api-server-2moiw.kinsta.app/api/form-submissions', {
        ...
        body: JSON.stringify({
          project_id: '5f75b3b0-7876-41d6-b100-816a729af8f2',  // NEW: Track which project this form belongs to
          website_id: '5f75b3b0-7876-41d6-b100-816a729af8f2',  // Legacy support
  ...
  <div className="max-w-2xl mx-auto px-4">
    ...
    <div className="text-center mb-12">
      ...
      <p className="text-lg text-slate-600">Let&apos;s explore how we can support your retail success</p>
    </div>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleChange}
            rows={5}
            placeholder="Share your retail goals, challenges, or any questions you'd like to discuss..."
            required
            className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none text-slate-900 placeholder-slate-400"
          />
        </div>
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold py-3 px-6 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed shadow-md hover:shadow-lg mt-8"
        >
